...
import net.cqyc.sample.clink.utils.ByteUtils;
import net.cqyc.sample.foo.constants.UDPConstants;
            ...
            try {
                ...
                while (!done) {
                    ...
                    if (cmd == 1 && responsePort > 0) {
                        ...
                        System.out.println("ServerProvider receive cmd nonsupportl cmd:" + cmd + "\tport:" + port);
                    }
                }
